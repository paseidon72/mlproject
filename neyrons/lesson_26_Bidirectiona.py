"""Как работают двунаправленные (bidirectional) рекуррентные нейросети. Как они реализуются с помощью пакета
Keras на примере задачи регрессии (прогнозирования значения случайной последовательности)."""
import os
