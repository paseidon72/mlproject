"""Как работают блоки GRU (Gated Recurrent Units) рекуррентных нейронных сетей. Подробный анализ их
архитектуры. Пример реализации слоя GRU в пакете Keras для задачи сентимент-анализа коротких высказываний.
