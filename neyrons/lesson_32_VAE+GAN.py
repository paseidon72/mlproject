"""Как работают генеративно-состязательные сети (Generative Adversarial Networks - GAN). Идея дискриминатора и
генератора для генерации реалистичных изображений. Показатели качества дискриминатора и генератора. Области
применения GAN."""
import os
