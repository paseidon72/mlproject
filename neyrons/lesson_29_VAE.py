"""Пример реализации простого вариационного автоэнкодера с помощью пакета Keras. Вы узнаете как оформить его
архитектуру через Lambda слой, как вычисляется дивергенция Кульбака-Лейблера и увидите результаты его работы."""
import os
...
#Делаем вариационный автоэнкодер (VAE) в Keras
